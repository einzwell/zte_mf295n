define(["knockout", "underscore", "jquery", "service", "config/config"], function (e, n, t, r, i) {
    ...
    function u() {
        var e = window.location.hash, r = n.find(m, function (n) {
            return n.hash == e
        });
    ...
    function h(e, r) {
        ...
        var i = ["3", "three", "2", "two"];
        -1 != n.indexOf(i, r) && $obj.hasClass("active") || ($obj.siblings().removeClass("active"), $obj.addClass("active"), $obj.siblings().not(".menu-two-level").slideUp(), $obj.next().has("ul li").slideDown())
    }
    ...
    function v() {
        var e = d(), r = n.filter(m, function (n) {
    ...
    function g(e) {
        for (var n = 0; n < m.length; n++) if (m[n].path == e) return !0;
        return !1
    }
    ...
    if ("CPE" == i.PRODUCT_TYPE) {
        ...
        m = e, i.SD_CARD_SUPPORT && (m = m.concat([{
            ...
            requireLogin: !1,
            checkSIMStatus: !1
        }, {hash: "#sdcard", path: "sd/sd", level: "", requireLogin: !0, checkSIMStatus: !1}, {
            hash: "#httpshare",
            path: "sd/httpshare",
            level: "",
            requireLogin: !0,
    ...
    var M = "";
    return m = m.concat([{hash: "#stk", path: "stk/stk", level: "", requireLogin: !0, checkSIMStatus: !0}]), {
        init: l,
        refreshMenu: s,
        findMenu: c,
        activeSubMenu: u,
